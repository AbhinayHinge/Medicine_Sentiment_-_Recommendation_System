...
def recommend(condition=list(medicine2['condition'].value_counts().index)):
    top_drugs = medicine2[medicine2['condition'] == condition][['drugName', 'usefulness']].sort_values(
        by='usefulness',
...
if st.button('Show Recommendation'):
    ...
    elif len(top_drugs) < 5:
        st.write("**Not enough medicines found for the selected condition**")
